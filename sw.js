...
const CACHE = 'nanmal-v54';
const FILES = [
  './', './play.html', './manifest.json', './css/style.css',
  './js/hangul.js', './js/data.js', './js/data2.js', './js/data3.js', './js/data4.js', './js/data5.js', './js/data6.js', './js/data7.js', './js/proverbs2.js', './js/crossword.js', './js/bgm.js', './js/scene.js', './js/theme.js', './js/dog.js',
