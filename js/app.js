  ...
  const App = {
    ...
    scrWalk(v) {
      ...
      v.appendChild(h('div', { class: 'card center compact' },
        ...
        h('div', { class: 'muted small', style: 'margin:4px 0 9px' }, `마실 ${Math.floor((d.level - 1) / 10) + 1} · ${11 - step}걸음 남았어요`),
      ...
      // 명소 삽화는 화면 아래 배경(body.tab-walk::after)으로 전체가 큼직하게
      // 깔리고, 카드는 반투명이라 그 위로 그림이 비쳐 보입니다.
    },
